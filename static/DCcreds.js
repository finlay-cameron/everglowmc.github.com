            ...
            .then(response => {
                ...
                docClient.get(params, function (err, data) {
                    if (err) {
                        ...
                        else {window.location.href = "https://discord.com/api/oauth2/authorize?client_id=817046480539222028&redirect_uri=https%3A%2F%2Feverglowmc.github.io%2Findex.html&response_type=code&scope=identify"}}
